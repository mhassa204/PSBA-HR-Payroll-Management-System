...
const SettingsDashboard = () => {
  ...
  const settingsCategories = [
    ...
    },
    {
      ...
      description:
        "Manage departments, designations, and organizational hierarchy",
      icon: Building2,
      items: [
        {
          name: "Departments",
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {category.items.map((item, itemIndex) => (
                    <div
                      key={itemIndex}
                      className={`p-6 rounded-lg border-2 cursor-pointer transition-all duration-200 transform hover:scale-105 ${getColorClasses(
                        item.color
                      )}`}
